...
output eventHubNamespaceName string = 'ehn-${appName}-${region}-${env}'
output eventHubName string = 'eh-${appName}-${region}-${env}'
output eventHubSendAuthorizationRuleName string = 'ehar-send-${appName}-${region}-${env}'
